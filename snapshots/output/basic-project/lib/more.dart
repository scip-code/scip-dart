...
class Animal with SleepMixin {
  ...
  String name;
  //  ^^^^^^ reference scip-dart pub dart:core 3.12.0 dart:core/`string.dart`/String#
  ...
  @override
  //   ^^^^^^^^ reference scip-dart pub dart:core 3.12.0 dart:core/`annotations.dart`/override.
  String toString() {
    //  ^^^^^^ reference scip-dart pub dart:core 3.12.0 dart:core/`string.dart`/String#
    //         ^^^^^^^^ definition scip-dart pub dart_test 1.0.0 lib/`more.dart`/Animal#toString().
    //         relationship scip-dart pub dart:core 3.12.0 dart:core/`object.dart`/Object#toString(). implementation reference
...
int calculateSum(List<int> numbers) {
  //^^^ reference scip-dart pub dart:core 3.12.0 dart:core/`int.dart`/int#
  //    ^^^^^^^^^^^^ definition scip-dart pub dart_test 1.0.0 lib/`more.dart`/calculateSum().
  //                 ^^^^ reference scip-dart pub dart:core 3.12.0 dart:core/`list.dart`/List#
  //                      ^^^ reference scip-dart pub dart:core 3.12.0 dart:core/`int.dart`/int#
  //                           ^^^^^^^ definition local 0
  return numbers.reduce((value, element) => value + element);
  //         ^^^^^^^ reference local 0
  //                 ^^^^^^ reference scip-dart pub dart:core 3.12.0 dart:core/`iterable.dart`/Iterable#reduce().
  //                         ^^^^^ definition local 1
  //                                ^^^^^^^ definition local 2
  //                                            ^^^^^ reference local 1
  //                                                    ^^^^^^^ reference local 2
...
void main() {
  ...
  //             ^^^^^^^^^ reference scip-dart pub dart:math 3.12.0 dart:math/`rectangle.dart`/Rectangle#`<constructor>`().
