(String, int) userInfo(Map<String, dynamic> json) {
  ...
  //                       ^^^ reference scip-dart pub dart:core 3.12.0 dart:core/`map.dart`/Map#
  //                           ^^^^^^ reference scip-dart pub dart:core 3.12.0 dart:core/`string.dart`/String#
  //                                            ^^^^ definition local 0
...
String describeDate(DateTime dt) {
  ...
  //                    ^^^^^^^^ reference scip-dart pub dart:core 3.12.0 dart:core/`date_time.dart`/DateTime#
  //                             ^^ definition local 10
  const one = 1;
  //        ^^^ definition local 11
  return switch (dt.weekday) {
    //                 ^^ reference local 10
    //                    ^^^^^^^ reference scip-dart pub dart:core 3.12.0 dart:core/`date_time.dart`/DateTime#`<get>weekday`.
